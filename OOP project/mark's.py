class Controller:
    ...
    def select_seat(self, flight_instance_no):
        ...
        show_seat_list = flight_instance.show_seat_list
        seat_detail = {}
        available_seat = []
        for seat in seat_list:
            ...
            for reserved_seat in show_seat_list:
...
class FlightInstance(Flight):
    ...
    def add_show_seat(self,show_seat):
        self.show_seat_list.append(show_seat)
...
# สร้าง ShowSeat
controller.flight_instance_list[0].add_show_seat(ShowSeat("1","A"))
